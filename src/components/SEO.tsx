...
export const SEO: React.FC<SEOProps> = ({
  ...
  const WEBSITE_URL = ''; // TODO Fill in your own website title here, or in a globals.ts
  const WEBSITE_TITLE = ''; // TODO Fill in your own website title here, or in a globals.ts
